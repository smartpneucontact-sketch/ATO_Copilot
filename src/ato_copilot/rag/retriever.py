...
from ato_copilot.rag.store import Chunk, RetrievedChunk
...
class Retriever:
    """In-memory BM25 retriever. Maps in production to Azure AI Search /
    SharePoint Search over State Street's governance document library."""
